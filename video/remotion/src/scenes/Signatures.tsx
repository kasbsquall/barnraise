...
const LEDGER = 555;     // 18.5s · the Agreements view opens on rows already signed
const CREAM = 642;      // 21.4s · the row both directors signed flips
const MAP = 858;        // 28.6s · back to the map, the line between them thicker
